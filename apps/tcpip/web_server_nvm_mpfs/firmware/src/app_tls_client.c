...
void APP_TLS_CLIENT_Tasks ( void )
{
    ...
    switch ( app_tls_clientData.state )
    {
        ...
        case APP_TLS_CLIENT_STATE_INIT:
        {
            ...
            app_tls_clientData.state = APP_TCPIP_WAIT_ON_DNS;
        }
        ...
        case APP_TCPIP_START_CONNECTION:
            ...
            app_tls_clientData.state = APP_TCPIP_WAIT_FOR_CONNECTION;
            break;
        case APP_TCPIP_WAIT_FOR_CONNECTION:
            ...
            if (!NET_PRES_SocketEncryptSocket(app_tls_clientData.socket)) {
                ...
                app_tls_clientData.state = APP_TCPIP_CLOSE_CONNECTION;
            } else {
                app_tls_clientData.state = APP_TCPIP_WAIT_FOR_SSL_CONNECT;
        ...
        case APP_TCPIP_WAIT_FOR_SSL_CONNECT:
            ...
            app_tls_clientData.state = APP_TCPIP_SEND_REQUEST_SSL;
            break;
        ...
        case APP_TCPIP_SEND_REQUEST_SSL:
            ...
            app_tls_clientData.state = APP_TCPIP_WAIT_FOR_RESPONSE_SSL;
            break;
