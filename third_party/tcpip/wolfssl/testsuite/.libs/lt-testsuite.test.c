...
/* testsuite/.libs/lt-testsuite.test.c - temporary wrapper executable for .libs/testsuite.test
   Generated by libtool (GNU libtool) 2.4.6

   The testsuite/testsuite.test program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "testsuite.test"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# testsuite/testsuite.test - temporary wrapper script for .libs/testsuite.test\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The testsuite/testsuite.test program cannot be directly executed until all th", f);
  fputs ("e libtool\n", f);
  ...
  fputs ("    echo \"testsuite.test:testsuite/testsuite.test:$LINENO: libtool wrapper (GNU", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"testsuite.test:testsuite/testsuite.test:$LINENO: newargv[$lt_dump_ar", f);
  fputs ("gs_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"testsuite.test:testsuite/testsuite.test:$LINENO: newargv[0]: $pr", f);
