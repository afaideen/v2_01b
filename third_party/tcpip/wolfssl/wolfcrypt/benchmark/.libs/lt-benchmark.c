...
/* wolfcrypt/benchmark/.libs/lt-benchmark.c - temporary wrapper executable for .libs/benchmark
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# wolfcrypt/benchmark/benchmark - temporary wrapper script for .libs/benchmark\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The wolfcrypt/benchmark/benchmark program cannot be directly executed until a", f);
  ...
  fputs ("    echo \"benchmark:wolfcrypt/benchmark/benchmark:$LINENO: libtool wrapper (GNU", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"benchmark:wolfcrypt/benchmark/benchmark:$LINENO: newargv[$lt_dump_ar", f);
  fputs ("gs_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"benchmark:wolfcrypt/benchmark/benchmark:$LINENO: newargv[0]: $pr", f);
