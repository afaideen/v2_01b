...
/* wolfcrypt/test/.libs/lt-testwolfcrypt.c - temporary wrapper executable for .libs/testwolfcrypt
...
const char * TARGET_PROGRAM_NAME = "testwolfcrypt"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# wolfcrypt/test/testwolfcrypt - temporary wrapper script for .libs/testwolfcry", f);
  fputs ("pt\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The wolfcrypt/test/testwolfcrypt program cannot be directly executed until al", f);
  fputs ("l the libtool\n", f);
  ...
  fputs ("    echo \"testwolfcrypt:wolfcrypt/test/testwolfcrypt:$LINENO: libtool wrapper (", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"testwolfcrypt:wolfcrypt/test/testwolfcrypt:$LINENO: newargv[$lt_dump", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"testwolfcrypt:wolfcrypt/test/testwolfcrypt:$LINENO: newargv[0]: ", f);
