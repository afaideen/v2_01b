...
/* examples/echoclient/.libs/lt-echoclient.c - temporary wrapper executable for .libs/echoclient
   Generated by libtool (GNU libtool) 2.4.6

   The examples/echoclient/echoclient program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/cygdrive/d/microchip/harmony/v2_01b/third_party/tcpip/wolfssl/src/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/cygdrive/d/microchip/harmony/v2_01b/third_party/tcpip/wolfssl/src/.libs:/usr/local/lib:/usr/local/bin:";
const char * TARGET_PROGRAM_NAME = "echoclient"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# examples/echoclient/echoclient - temporary wrapper script for .libs/echoclien", f);
  fputs ("t\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The examples/echoclient/echoclient program cannot be directly executed until ", f);
  fputs ("all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' src/libwolfssl.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"echoclient:examples/echoclient/echoclient:$LINENO: libtool wrapper (G", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"echoclient:examples/echoclient/echoclient:$LINENO: newargv[$lt_dump_", f);
  fputs ("args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"echoclient:examples/echoclient/echoclient:$LINENO: newargv[0]: $", f);
  ...
  fputs ("    PATH=/cygdrive/d/microchip/harmony/v2_01b/third_party/tcpip/wolfssl/src/.li", f);
  fputs ("bs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/d/microchip/harmony/v2_01b/third_party/tcpip/wolfssl/src/.l", f);
  fputs ("ibs:$PATH\"\n", f);
  fputs ("\n", f);
