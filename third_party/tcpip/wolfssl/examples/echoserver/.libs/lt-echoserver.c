...
/* examples/echoserver/.libs/lt-echoserver.c - temporary wrapper executable for .libs/echoserver
   Generated by libtool (GNU libtool) 2.4.6

   The examples/echoserver/echoserver program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "echoserver"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# examples/echoserver/echoserver - temporary wrapper script for .libs/echoserve", f);
  fputs ("r\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The examples/echoserver/echoserver program cannot be directly executed until ", f);
  ...
  fputs ("    echo \"echoserver:examples/echoserver/echoserver:$LINENO: libtool wrapper (G", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"echoserver:examples/echoserver/echoserver:$LINENO: newargv[$lt_dump_", f);
  fputs ("args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"echoserver:examples/echoserver/echoserver:$LINENO: newargv[0]: $", f);
