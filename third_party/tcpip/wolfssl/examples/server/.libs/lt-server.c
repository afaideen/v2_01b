...
/* examples/server/.libs/lt-server.c - temporary wrapper executable for .libs/server
   Generated by libtool (GNU libtool) 2.4.6

   The examples/server/server program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "server"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# examples/server/server - temporary wrapper script for .libs/server\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The examples/server/server program cannot be directly executed until all the ", f);
  fputs ("libtool\n", f);
  ...
  fputs ("    echo \"server:examples/server/server:$LINENO: libtool wrapper (GNU libtool) ", f);
  fputs ("2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"server:examples/server/server:$LINENO: newargv[$lt_dump_args_N]: $lt", f);
  fputs ("_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"server:examples/server/server:$LINENO: newargv[0]: $progdir/$pro", f);
  fputs ("gram\" 1>&2\n", f);
